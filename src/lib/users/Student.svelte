...
<a href="mailto:{email}" class="grid w-full grid-cols-[auto_1fr] items-center gap-2 p-2 preset-filled-surface-100-900 hover:preset-filled-surface-200-800 rounded-md transition-colors duration-150">
