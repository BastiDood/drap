  ...
  {#if selectedLabs.length > 0}
    <ol class="space-y-2">
      {#each selectedLabs as { id, name }, idx (id)}
        ...
        <li class="card preset-tonal-surface border-surface-500 card-hover border p-4 flex flex-col gap-4">
          ...
          <textarea
            class="card preset-tonal-surface border-surface-500 h-16 min-h-16 w-full"
            name="remarks"
            placeholder="Remarks"
            maxlength="1028"
          ></textarea>
