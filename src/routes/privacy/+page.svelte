<section class="prose dark:prose-invert max-w-none">
  ...
  <section>
    <h2>Introduction</h2>
    <p>
      In compliance with the UP Diliman Privacy Policy, complemented by the UP Diliman Data Subject
      Rights and Responsibilities, and relevant data privacy regulations, DRAP: Draft Ranking
      Automated Processor respects your privacy and safeguards your personal data. This Privacy
      Policy notice serves to inform the users of DRAP the purpose of the collection of student data
      and the extent of the processing of that data. By using this web application, you consent to
  ...
  <section>
    ...
    <p>
      We collect personal information that you willingly provide when utilizing this application.
    </p>
    <ul>
      <li><strong>Full name:</strong> for the personal identification of the student.</li>
      <li>
        <strong>Student number:</strong> for ensuring the validity of your student information.
      </li>
      <li><strong>UP email address:</strong> for communication purposes.</li>
      <li>
        <strong>Google user ID:</strong> for authentication and authorization through Google OpenID Connect
        via OAuth 2.0.
      </li>
      <li>
        <strong>Other data:</strong> includes student lab preferences and rankings by students and faculty
        members.
      </li>
    </ul>
  ...
  <section>
    ...
    <p>
      We utilize your data for automating the process of the yearly draft of research lab
      assignments.
    </p>
  </section>
  <section>
  ...
  <section>
    ...
    <ul>
      ...
      <li>
        ...
        or incomplete, you may request corrections.
      </li>
