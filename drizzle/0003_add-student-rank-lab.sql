...
ALTER TABLE "drap"."student_rank_lab" ADD CONSTRAINT "student_rank_lab_lab_id_lab_lab_id_fk" FOREIGN KEY ("lab_id") REFERENCES "drap"."lab"("lab_id") ON DELETE no action ON UPDATE cascade;