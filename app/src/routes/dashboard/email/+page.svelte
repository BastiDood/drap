...
<div class="grid grid-cols-1 items-start gap-4 lg:grid-cols-[auto_1fr]">
    <div class="prose dark:prose-invert max-w-none lg:max-w-prose">
        ...
        <p>
            To enable email notifications, one of the draft administrators must first volunteer themselves to be the
            <strong>Designated Sender</strong> of the system. All emails will be sent on behalf of the
            <dfn>designated sender</dfn>. There are <em>no</em> special Gmail accounts; the personal email account of
            the designated sender will be used for all email notifications
            <em>as if they had sent the notification themselves</em>.
        </p>
        <p>
            Given the security implications and risks of impersonation, the sensitive privilege to send emails on behalf
            of administrators <em>requires</em> elevated consent. Thus, before becoming a designated sender, an
            administrator must first volunteer themselves to be a <strong>Candidate Sender</strong> via the button below
            (which will be disabled if the administrator has already volunteered previously). Pressing the button redirects
            the user to the Google consent screen.
        </p>
        ...
        <p>
            Consenting candidate senders are listed on this page. Using the <strong>"Promote"</strong> buton, each
            candidate sender may then be promoted as the designated sender of the system. Analogously, the
